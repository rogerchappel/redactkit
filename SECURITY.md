...
Replace this section with the supported versions for `redactkit`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `redactkit` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in redactkit.
